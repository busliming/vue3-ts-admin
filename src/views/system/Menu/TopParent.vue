...
import useTopParent from '@/composables/menu/useTopParent';
...
// 数的相关属性和方法
const { treeData, defaultProps, handleNodeClick, getParentList, selected,parentTreeRef,openBtn } = useTopParent()
</script>
<style lang='scss'>
.el-tree {

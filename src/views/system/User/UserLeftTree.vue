    ...
    <template #default="{ node, data }">
      <span class="custom-tree-node">
        ...
        <span v-if="data.children.length === 0">
          <DocumentRemove
            style="width: 1.2em;height: 1.2em; margin-right: 5px;color:#8c8c8c ; vertical-align: middle;"
          ></DocumentRemove>
        </span>
...
const { treeData, defaultProps, leftTreeRef, handleNodeClick, openBtn } = useLeftTree(emit);
</script>
<style lang='scss'>
.el-tree {
